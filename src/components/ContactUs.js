  ...
  return (
    <section className="bg-gray-100 dark:bg-gray-900 text-gray-700 dark:text-gray-50 py-16 ">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-left md:items-center space-y-8 md:space-y-0 md:space-x-16">
          {/* Phone Number */}
          <div className="flex items-left md:items-center space-x-4">
